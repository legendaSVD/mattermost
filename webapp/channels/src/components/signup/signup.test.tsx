...
describe('components/signup/Signup', () => {
    ...
    it('should create user, log in and redirect to invite teamname', async () => {
        ...
        mockDispatch = jest.fn().
            ...
            mockResolvedValueOnce({data: {id: 'userId', password: 'password', email: 'jdoe@mm.com}'}}).
            mockResolvedValueOnce({error: {server_error_id: 'api.user.login.not_verified.app_error'}});
        renderWithContext(
            <Signup/>,
        );
    ...
    it('should add user to team and redirect when team invite valid and logged in', async () => {
        ...
        mockCurrentUserId = 'user1';
        mockDispatch = jest.fn().
            mockResolvedValueOnce({}).
            mockResolvedValueOnce({data: {name: 'teamName'}});
        renderWithContext(
            <Signup/>,
        );
        await waitFor(() => {
