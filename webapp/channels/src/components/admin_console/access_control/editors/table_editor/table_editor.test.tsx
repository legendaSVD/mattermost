...
describe('findFirstAvailableAttributeFromList', () => {
    ...
    test('returns first attribute that is synced from LDAP', () => {
        const attributes = [
            createMockAttribute('invalid attribute'),
            createMockAttribute('unsafe_attribute'),
            createMockAttribute('ldap_attribute', {ldap: 'ldap_field'}),
        ];
    ...
    test('returns first attribute that is synced from SAML', () => {
        const attributes = [
            createMockAttribute('invalid attribute'),
            createMockAttribute('saml_attribute', {saml: 'saml_field'}),
        ];
        const result = findFirstAvailableAttributeFromList(attributes, false);
    ...
    test('returns first attribute that is admin-managed', () => {
        const attributes = [
            createMockAttribute('invalid attribute'),
            createMockAttribute('unsafe_attribute'),
            createMockAttribute('admin_managed_attribute', {managed: 'admin'}),
        ];
        const result = findFirstAvailableAttributeFromList(attributes, false);
    ...
    test('returns first attribute that is plugin-managed (protected)', () => {
        const attributes = [
            createMockAttribute('invalid attribute'),
            createMockAttribute('unsafe_attribute'),
            createMockAttribute('protected_attribute', {protected: true, source_plugin_id: 'com.example.plugin'}),
        ];
        const result = findFirstAvailableAttributeFromList(attributes, false);
    ...
    test('skips attributes with spaces even when synced', () => {
        const attributes = [
            createMockAttribute('synced attribute', {ldap: 'ldap_field'}),
