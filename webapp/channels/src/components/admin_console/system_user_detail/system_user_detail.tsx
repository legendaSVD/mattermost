...
export class SystemUserDetail extends PureComponent<Props, State> {
    ...
    getUser = async (userId: UserProfile['id']) => {
        ...
        try {
            ...
            console.error('SystemUserDetails-getUser: ', error);
            this.setState({
                isLoading: false,
    ...
    handleActivateUser = async () => {
        ...
        try {
            ...
            console.error('SystemUserDetails-handleActivateUser', err);
    ...
    handleDeactivateMember = async () => {
        ...
        try {
            ...
            console.error('SystemUserDetails-handleDeactivateMember', err);
    ...
    handleRemoveMFA = async () => {
        ...
        try {
            ...
            console.error('SystemUserDetails-handleRemoveMFA', err);
    ...
    handleConfirmSave = async () => {
        ...
        try {
            ...
            console.error('SystemUserDetails-handleConfirmSave', err);
            this.setState({
