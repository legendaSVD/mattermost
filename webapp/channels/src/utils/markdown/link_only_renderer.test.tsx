...
describe('formatWithRenderer | LinkOnlyRenderer', () => {
    const testCases = [
        ...
        },
        {
            ...
            outputText: 'H6 header <a class="theme markdown__link" href="https:
            'link 1</a> - <a class="theme markdown__link" href="https:
        },
        {
        ...
        },
        {
            ...
            outputText: '<a class="theme markdown__link" href="http:
            'inline-style link</a>',
        },
        {
        ...
        },
        {
            ...
            outputText: 'Do you like <a class="theme markdown__link" href="http:
        ...
        },
        {
            ...
            outputText: 'Let&#39;s try <a class="theme markdown__link" href="http:
        },
        {
            description: 'link: link with a full-length punctuation',
            inputText: 'Do you like https://mattermost.com/，這是第二個網址。?',
            outputText: 'Do you like <a class="theme markdown__link" href="https:
