...
describe('PostUtils', () => {
    ...
    describe('isSystemMessage', () => {
        const testCases = [
            ...
            {input: TestHelper.getPostMock({type: PostTypes.JOIN_LEAVE}), output: true},
            {input: TestHelper.getPostMock({type: PostTypes.ADD_REMOVE}), output: true},
    ...
    describe('isUserActivityPost', () => {
        const testCases = [
            ...
            {input: PostTypes.JOIN_LEAVE, output: false},
            {input: PostTypes.ADD_REMOVE, output: false},
