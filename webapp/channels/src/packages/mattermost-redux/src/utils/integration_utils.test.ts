...
describe('integration utils', () => {
    ...
    describe('date and datetime validation', () => {
        ...
        it('should return error for invalid date formats', () => {
            ...
            expect(checkDialogElementForError(dateElement, '2025-13-01')).toBeTruthy();
            expect(checkDialogElementForError(dateElement, '2025-01-32')).toBeTruthy();
        ...
        it('should return error for invalid datetime formats', () => {
            ...
            expect(checkDialogElementForError(datetimeElement, '2025-01-15')).toBeTruthy();
            expect(checkDialogElementForError(datetimeElement, '2025-01-15T14:30Z')).toBeTruthy();
            expect(checkDialogElementForError(datetimeElement, '2025-01-15T14:30:00')).toBeTruthy();
            expect(checkDialogElementForError(datetimeElement, '2025-01-15T14:30')).toBeTruthy();
        });
