...
func TestParseValidSVGData(t *testing.T) {
	...
	validSVGs := []io.Reader{
		generateSVGData(width, height, true, true, false),
		generateSVGData(width, height, true, true, true),
		generateSVGData(width, height, false, true, false),
		generateSVGData(width, height, false, true, true),
	}
...
func TestParseInvalidSVGData(t *testing.T) {
	...
	invalidSVGs := []io.Reader{
		generateSVGData(width, height, false, false, false),
		generateSVGData(width, 0, false, true, false),
		generateSVGData(width, 0, false, true, false),
	}
