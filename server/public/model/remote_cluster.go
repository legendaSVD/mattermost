...
const (
	RemoteOfflineAfterMillis = 1000 * 60 * 5
...
type RemoteCluster struct {
	...
	LastGlobalUserSyncAt int64   `json:"last_global_user_sync_at"`
	Token                string  `json:"token"`
	RemoteToken          string  `json:"remote_token"`
	Topics               string  `json:"topics"`
	CreatorId            string  `json:"creator_id"`
	PluginID             string  `json:"plugin_id"`
	Options              Bitmask `json:"options"`
}
...
type RemoteClusterInvite struct {
	...
	SiteURL        string `json:"site_url"`
	Token          string `json:"token"`
	RefreshedToken string `json:"refreshed_token,omitempty"`
