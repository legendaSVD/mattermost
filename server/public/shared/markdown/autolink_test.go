...
func TestAutolinking(t *testing.T) {
	for name, tc := range map[string]struct {
		...
		"valid-link-2": {
			...
			ExpectedHTML: `<p><a href="https:
		},
		"valid-link-3": {
			Markdown:     `ftp://example.com`,
			ExpectedHTML: `<p><a href="ftp:
		},
		"valid-link-5": {
		...
		"valid-link-20": {
			...
			ExpectedHTML: `<p><a href="mailto:
		},
		"valid-link-21": {
			Markdown:     `tel://555-123-4567`,
			ExpectedHTML: `<p><a href="tel:
		},
		"ip-address-1": {
		...
		"link-in-sentence-2": {
			...
			ExpectedHTML: `<p>(see <a href="http:
		},
		"link-in-sentence-3": {
		...
		"link-in-sentence-4": {
			...
			ExpectedHTML: `<p>This is a sentence with a <a href="http:
		},
		"link-in-sentence-5": {
		...
		"link-in-sentence-7": {
			Markdown:     `This is a sentence with a link (http://example.com) in it.`,
			ExpectedHTML: `<p>This is a sentence with a link (<a href="http:
		},
		"link-in-sentence-8": {
			Markdown:     `This is a sentence with a (https://en.wikipedia.org/wiki/Rendering_(computer_graphics)) in it.`,
			ExpectedHTML: `<p>This is a sentence with a (<a href="https:
		},
		"link-in-sentence-9": {
		...
		"link-in-sentence-14": {
			...
			ExpectedHTML: `<p>This is a question about a link <a href="http:
		},
